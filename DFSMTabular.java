/*
∗ @file: DFSMTabular. java
∗ @description: This program implements the DFSMTabular.
∗ @author: Julia Jiang
...
public class DFSMTabular {
    ...
    public DFSMTabular() {
        ...
        acceptingStates.set(3, true);
        acceptingStates.set(18, true); //REPLACING ??? WITH THE INTEGER ID OF ANY ACCEPTING STATE
